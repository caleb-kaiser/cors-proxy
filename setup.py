#!/usr/bin/env python
"""
Package metadata for cors_proxy.
"""
import os
import re
import sys
...
VERSION = get_version('cors_proxy', '__init__.py')
...
setup(
    ...
    author='Caleb',
    author_email='caleb@comet.com',
    url='https://github.com/caleb-kaiser/cors-proxy',
    packages=find_packages(
        include=['cors_proxy', 'cors_proxy.*'],
        exclude=["*tests"],
    ),
