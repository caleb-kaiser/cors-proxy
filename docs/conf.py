...
"""
cors-proxy documentation build configuration file.
...
html_context = {
    ...
    "github_repo": 'cors-proxy',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/caleb-kaiser/cors-proxy",
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'cors_proxy'),
                os.path.join(root_path, 'cors_proxy/migrations')])
